...
static void glad_gl_load_GL_VERSION_3_0(GLADuserptrloadfunc load, void* userptr) {
	...
	glGetTransformFeedbackVarying = (PFNGLGETTRANSFORMFEEDBACKVARYINGPROC)
		load("glGetTransformFeedbackVarying", userptr);
...
static void glad_gl_load_GL_VERSION_3_2(GLADuserptrloadfunc load, void* userptr) {
	...
	glDrawRangeElementsBaseVertex = (PFNGLDRAWRANGEELEMENTSBASEVERTEXPROC)
		load("glDrawRangeElementsBaseVertex", userptr);
	...
	glMultiDrawElementsBaseVertex = (PFNGLMULTIDRAWELEMENTSBASEVERTEXPROC)
		load("glMultiDrawElementsBaseVertex", userptr);
...
static void glad_gl_load_GL_VERSION_3_3(GLADuserptrloadfunc load, void* userptr) {
	...
	glBindFragDataLocationIndexed = (PFNGLBINDFRAGDATALOCATIONINDEXEDPROC)
		load("glBindFragDataLocationIndexed", userptr);
...
static void glad_gl_free_extensions(char** exts_i, unsigned int num_exts_i) {
	if (exts_i != NULL) {
		for (unsigned int index = 0; index < num_exts_i; index++) {
...
int gladLoadGLUserPtr(GLADuserptrloadfunc load, void* userptr) {
	...
	const int version = glad_gl_find_core_gl();
