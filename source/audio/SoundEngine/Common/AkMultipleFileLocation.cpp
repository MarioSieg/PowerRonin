...
AKRESULT CAkMultipleFileLocation::Open(const AkOSChar* in_pszFileName,
                                       // File name.
...
AKRESULT CAkMultipleFileLocation::Open(AkFileID in_fileID,
                                       // File ID.
                                       AkOpenMode in_eOpenMode,
                                       // Open mode.
                                       AkFileSystemFlags* in_pFlags,
...
AKRESULT CAkMultipleFileLocation::GetFullFilePath(const AkOSChar* in_pszFileName,
                                                  // File name.
                                                  AkFileSystemFlags* in_pFlags,
