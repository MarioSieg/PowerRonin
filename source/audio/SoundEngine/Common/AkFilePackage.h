...
public:
	...
	static T_PACKAGE* Create(const AkOSChar* in_pszPackageName,
	                         // Name of the file package (for memory monitoring and ID generation).
...
protected:
	...
	CAkFilePackage(AkUInt32 in_uPackageID, AkUInt32 in_uHeaderSize, void* in_pToRelease) : m_uPackageID(in_uPackageID), m_uHeaderSize(in_uHeaderSize), m_pToRelease(in_pToRelease), m_uRefCount(1) { }
	...
	// Helper.
	static void ClearMemory(void* in_pMemToRelease // Memory block to free before destroying pool.
	);
