...
AKRESULT CAkFileLocationBase::GetFullFilePath(const AkOSChar* in_pszFileName,
                                              // File name.
...
// Returns AK_Success if input flags are supported and the resulting path is not too long.
// Returns AK_Fail otherwise.
AKRESULT CAkFileLocationBase::GetFullFilePath(AkFileID in_fileID,
                                              // File ID.
                                              AkFileSystemFlags* in_pFlags,
                                              // Special flags. 
                                              AkOpenMode /* in_eOpenMode*/,
	...
	if (!in_pFlags || !(in_pFlags->uCompanyID == AKCOMPANYID_AUDIOKINETIC || in_pFlags->uCompanyID == AKCOMPANYID_AUDIOKINETIC_EXTERNAL)) {
...
AKRESULT CAkFileLocationBase::SetBasePath(const AkOSChar* in_pszBasePath) {
...
AKRESULT CAkFileLocationBase::SetBankPath(const AkOSChar* in_pszBankPath) {
...
AKRESULT CAkFileLocationBase::SetAudioSrcPath(const AkOSChar* in_pszAudioSrcPath) {
