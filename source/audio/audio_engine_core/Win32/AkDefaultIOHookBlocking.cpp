...
auto CAkDefaultIOHookBlocking::Init(
...
auto CAkDefaultIOHookBlocking::Open(
...
auto CAkDefaultIOHookBlocking::Read(
...
auto CAkDefaultIOHookBlocking::Write(
	AkFileDesc& in_fileDesc, // File descriptor.
	const AkIoHeuristics& /*in_heuristics*/, // Heuristics for this data transfer (not used in this implementation).
...
// Cleans up a file.
auto CAkDefaultIOHookBlocking::Close(
	AkFileDesc& in_fileDesc // File descriptor.
) -> AKRESULT {
...
auto CAkDefaultIOHookBlocking::GetBlockSize(
	AkFileDesc& /*in_fileDesc*/ // File descriptor.
) -> AkUInt32 {
...
auto CAkDefaultIOHookBlocking::GetDeviceData() -> AkUInt32 {
