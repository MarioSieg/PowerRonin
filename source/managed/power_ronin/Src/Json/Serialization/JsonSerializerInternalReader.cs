...
using PowerRonin.Json.Linq;
using PowerRonin.Json.Utilities;
#if !HAVE_LINQ
using PowerRonin.Json.Utilities.LinqBridge;
...
namespace PowerRonin.Json.Serialization
{
    internal class JsonSerializerInternalReader : JsonSerializerInternalBase
    {
        ...
        public void Populate(JsonReader reader, object target)
        {
            ...
            if (!reader.MoveToContent()) throw JsonSerializationException.Create(reader, "No JSON content found.");
        ...
        private JToken? CreateJToken(JsonReader reader, JsonContract? contract)
        {
            ...
            if (contract != null)
            {
                if (contract.UnderlyingType == typeof(JRaw)) return JRaw.Create(reader);
            ...
            using (var writer = new JTokenWriter())
            {
                ...
                do
                {
                    if (reader.TokenType == JsonToken.PropertyName)
                    {
                        ...
                        if (!reader.ReadAndMoveToContent()) break;
            ...
            do
            {
                switch (reader.TokenType)
                {
                    ...
                    case JsonToken.String:
                        ...
                        if (CoerceEmptyStringToNull(objectType, contract, s)) return null;
            ...
            object? existingValue, out object? newValue, out string? id)
        {
            ...
            if (reader.TokenType == JsonToken.StartObject)
            {
                ...
                if (idToken != null) id = (string?) idToken;
            ...
            object? existingValue, string? id)
        {
            ...
            if (HasNoDefinedType(contract)) return CreateJToken(reader, contract);
            ...
            Type? targetType)
        {
            ...
            {
                if (value == null && contract.IsNullable) return null;
            ...
            JsonContainerContract? containerContract, JsonProperty? containerProperty, JsonReader reader, object target)
        {
            ...
            {
                if (!gottenCurrentValue && property.Readable) currentValue = property.ValueProvider!.GetValue(target);
            ...
            out bool ignoredValue)
        {
            ...
            if (property.Ignored) return true;
            ...
            out bool createdFromNonDefaultCreator)
        {
            ...
            if (contract.OverrideCreator != null)
            {
                ...
                if (contract.ShouldCreateWrapper) list = contract.CreateWrapper(list);
            ...
            out bool createdFromNonDefaultCreator)
        {
                                                        ...
                                                        .AllowNonPublicDefaultConstructor))
            {
                ...
                if (contract.ShouldCreateWrapper) dictionary = contract.CreateWrapper(dictionary);
            ...
            JsonProperty? containerProperty, string? id)
        {
            ...
            if (contract.KeyContract == null) contract.KeyContract = GetContractSafe(contract.DictionaryKeyType);
            ...
            do
            {
                switch (reader.TokenType)
                {
                    case JsonToken.PropertyName:
                        ...
                        if (CheckPropertyName(reader, keyValue.ToString())) continue;
 ...
 DateTimeUtils.TryParseDateTimeOffset(keyValue.ToString(), reader.DateFormatString, reader.Culture, out DateTimeOffset dt)
            ...
            JsonProperty? containerProperty, string? id)
        {
            ...
            if (id != null) AddReference(reader, id, list);
...
#pragma warning disable CS8600, CS8602, CS8603, CS8604
            ...
            if (contract.ItemContract == null) contract.ItemContract = GetContractSafe(contract.CollectionItemType);
...
#pragma warning restore CS8600, CS8602, CS8603, CS8604
 ...
 CreateValueInternal(reader, t, dynamicMemberContract, null, null, member, null);
            ...
            JsonProperty? containerProperty, JsonReader reader, Type objectType)
        {
            ...
            if (!exit) ThrowUnexpectedEndException(reader, contract, null, "Unexpected end when deserializing object.");
        ...
        {
            if (property.ShouldDeserialize == null) return true;
