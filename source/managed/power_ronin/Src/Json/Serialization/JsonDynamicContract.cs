...
namespace Dreamcast.Json.Serialization
{
 ...
 (GetMemberBinder)DynamicUtils.BinderWrapper.GetMember(name, typeof(DynamicUtils));
        ...
        private static CallSite<Dreamcast.Json.Serialization.Func<CallSite, object, object?, object>> CreateCallSiteSetter(string name)
        {
            SetMemberBinder binder = (SetMemberBinder)DynamicUtils.BinderWrapper.SetMember(name, typeof(DynamicUtils));

            return CallSite<Dreamcast.Json.Serialization.Func<CallSite, object, object?, object>>.Create(new NoThrowSetBinderMember(binder));
        }
        ...
        internal bool TryGetMember(IDynamicMetaObjectProvider dynamicProvider, string name, out object? value)
        {
            ...
            CallSite<Dreamcast.Json.Serialization.Func<CallSite, object, object>> callSite = _callSiteGetters.Get(name);
