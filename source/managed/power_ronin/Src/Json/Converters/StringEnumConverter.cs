...
namespace PowerRonin.Json.Converters
{
    ...
    public class StringEnumConverter : JsonConverter
    {
        ...
        ///     <see cref="Serialization.NamingStrategy" /> used to write enum text.
        /// </param>
        ...
        ///     The parameter list to use when constructing the <see cref="Serialization.NamingStrategy" />
        ///     described by <paramref name="namingStrategyType" />.
        ///     If <c>null</c>, the default constructor is used.
        ///     When non-<c>null</c>, there must be a constructor defined in the
        ///     <see cref="Serialization.NamingStrategy" /> that exactly matches the number,
