using System;
using PowerRonin.Lua.Interpreter.Interop;
...
namespace PowerRonin.Lua.Interpreter
{
    ...
    public class ScriptRuntimeException : InterpreterException
    {
        ...
        {
            return new("attempt to get length of a {0} value", r.Type.ToLuaTypeString());
        }
        ...
        {
            return new("bad argument #{0} to '{1}' ({2})", argNum + 1, funcName, message);
        }
        ...
        {
            return new("bad argument #{0} to '{1}' ({2} expected, got no value)",
        ...
        {
            return new("bad argument #{0} to '{1}' (index out of range)", argNum + 1, funcName);
        }
        ...
        {
            return new("bad argument #{0} to '{1}' (not a non-negative number in proper range)",
                argNum + 1, funcName);
        }
        ...
        {
            return new("bad argument #{0} to '{1}' (value expected)",
                argNum + 1, funcName);
        }
        ...
        {
            return new("attempt to index a {0} value", obj.Type.ToLuaTypeString());
        }
        ...
        {
            return new("cannot convert clr type {0}", obj.GetType());
        }
        ...
        {
            return new("cannot convert a {0} to a clr type", t.ToString().ToLowerInvariant());
        }
        ...
        {
            return new("cannot convert a {0} to a clr type {1}", t.ToString().ToLowerInvariant(), t2.FullName);
        }
        ...
        {
            return new("cannot access field {0} of userdata<{1}>", fieldname, typename);
        }
        ...
        {
            return new("attempt to yield across a CLR-call boundary");
        }
        ...
        {
            return new("attempt to yield from outside a coroutine");
        }
        ...
        {
            return new("attempt to access instance member {0} from a static userdata", desc.Name);
        }
