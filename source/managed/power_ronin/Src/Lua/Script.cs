...
using System.Linq;
using System.Text;
using PowerRonin.Lua.Interpreter.CoreLib;
using PowerRonin.Lua.Interpreter.Debugging;
using PowerRonin.Lua.Interpreter.Diagnostics;
using PowerRonin.Lua.Interpreter.Execution.VM;
using PowerRonin.Lua.Interpreter.IO;
using PowerRonin.Lua.Interpreter.Platforms;
using PowerRonin.Lua.Interpreter.Tree.Expressions;
using PowerRonin.Lua.Interpreter.Tree.Fast_Interface;
...
#pragma warning restore 618
        ...
        {
            return new(m_MainProcessor, func, null, true);
        }
