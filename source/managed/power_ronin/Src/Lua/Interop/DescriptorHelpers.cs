...
namespace PowerRonin.Lua.Interpreter.Interop
{
    ...
    public static class DescriptorHelpers
    {
        ...
        public static bool? GetVisibilityFromAttributes(this MemberInfo mi)
        {
            ...
            if (va != null && ha != null && va.Visible)
                throw new InvalidOperationException(
                    $"A member ('{mi.Name}') can't have discording Dreamcast.LuaHiddenAttribute and Dreamcast.LuaVisibleAttribute.");
            if (ha != null)
                return false;
            return va?.Visible;
        }
        ...
        ///     <see cref="PowerRonin.LuaUserDataMetamethodAttribute" /> .
        /// </summary>
