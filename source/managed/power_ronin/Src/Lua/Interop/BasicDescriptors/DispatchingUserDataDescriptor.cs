...
namespace PowerRonin.Lua.Interpreter.Interop.BasicDescriptors
{
    /// <summary>
    ...
    public abstract class DispatchingUserDataDescriptor : IUserDataDescriptor, IOptimizableDescriptor
    {
        ...
        ///     If a method exists marked with <see cref="PowerRonin.LuaUserDataMetamethodAttribute" /> for the specific
