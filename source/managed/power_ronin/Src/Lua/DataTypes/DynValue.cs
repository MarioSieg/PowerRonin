...
namespace PowerRonin.Lua.Interpreter
{
    ...
    public sealed class DynValue
    {
        ...
        {
            return new() {Number = v ? 1 : 0, Type = DataType.Boolean};
        }
        ...
        {
            return new() {Number = num, Type = DataType.Number, m_HashCode = -1};
        }
        ...
        {
            return new() {m_Object = str, Type = DataType.String};
        }
        ...
        {
            return new() {m_Object = sb.ToString(), Type = DataType.String};
        }
        ...
        {
            return new() {m_Object = string.Format(format, args), Type = DataType.String};
        }
        ...
        {
            return new() {m_Object = coroutine, Type = DataType.Thread};
        }
        ...
        {
            return new() {m_Object = function, Type = DataType.Function};
        }
        ...
        {
            return new() {m_Object = function, Type = DataType.ClrFunction};
        }
        ...
        {
            return new() {m_Object = table, Type = DataType.Table};
        }
        ...
        {
            return new() {m_Object = tailCallData, Type = DataType.TailCallRequest};
        }
        ...
        {
            return new() {m_Object = new YieldRequest {ReturnValues = args}, Type = DataType.YieldRequest};
        }
        ...
        {
            return new() {m_Object = new YieldRequest {Forced = true}, Type = DataType.YieldRequest};
        }
        ...
        {
            return new() {m_Object = userData, Type = DataType.UserData};
        }
