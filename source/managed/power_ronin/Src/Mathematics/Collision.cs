...
namespace PowerRonin.Mathematics
{
    ...
    public static class Collision
    {
        ...
        public static bool RayIntersectsRay(ref Ray ray1, ref Ray ray2, out Vector3 point)
        {
            ...
            var dets = m11 * m22 * m33 + m12 * m23 * m31 + m13 * m21 * m32 - m11 * m23 * m32 - m12 * m21 * m33 -
                       m13 * m22 * m31;
            ...
            var dett = m11 * m22 * m33 + m12 * m23 * m31 + m13 * m21 * m32 - m11 * m23 * m32 - m12 * m21 * m33 -
                       m13 * m22 * m31;
            ...
            if (!MathUtil.NearEqual(point2.X, point1.X) || !MathUtil.NearEqual(point2.Y, point1.Y) ||
        ...
        */
        ...
        {
            if (box.Minimum.X <= point.X && box.Maximum.X >= point.X && box.Minimum.Y <= point.Y &&
                box.Maximum.Y >= point.Y && box.Minimum.Z <= point.Z &&
