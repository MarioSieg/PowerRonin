...
namespace PowerRonin.Mathematics.Fast.Interpolated
{
    public sealed class MemoizedInterpolatedLog : IMemoizedMethod
    {
        ...
        public static MemoizedInterpolatedLog ConstructByValuesCount(float minArgument, float maxArgument, float @base,
            int valuesCount)
        {
