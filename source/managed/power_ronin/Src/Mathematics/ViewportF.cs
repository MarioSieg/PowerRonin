    ...
    public struct ViewportF : IEquatable<ViewportF>
    {
        ...
        public bool Equals(ref ViewportF other)
        {
            return MathUtil.NearEqual(X, other.X) && MathUtil.NearEqual(Y, other.Y) &&
                   ...
                   MathUtil.NearEqual(Height, other.Height) && MathUtil.NearEqual(MinDepth, other.MinDepth) &&
        ...
        public void Project(ref Vector3 source, ref Matrix4x4 matrix, out Vector3 vector)
        {
        ...
        public void Unproject(ref Vector3 source, ref Matrix4x4 matrix, out Vector3 vector)
        {
        ...
        public float AspectRatio
        {
            get
            {
                if (!MathUtil.IsZero(Height)) return Width / Height;
                return 0f;
            }
        }
