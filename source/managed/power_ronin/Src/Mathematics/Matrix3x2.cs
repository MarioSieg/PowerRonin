...
namespace PowerRonin.Mathematics
{
    ...
    public struct Matrix3x2
    {
                ...
                switch (index)
                {
                    ...
                    default:
                        throw new ArgumentOutOfRangeException("index",
                            "Indices for Matrix3x2 run from 0 to 5, inclusive.");
                }
            }
        }
        ...
        public static void Transformation(float xScale, float yScale, float angle, float xOffset, float yOffset,
        ...
        public string ToString(IFormatProvider formatProvider)
        {
            return string.Format(formatProvider, "[M11:{0} M12:{1}] [M21:{2} M22:{3}] [M31:{4} M32:{5}]",
                ...
                M12.ToString(formatProvider), M21.ToString(formatProvider), M22.ToString(formatProvider),
                M31.ToString(formatProvider),
        ...
        public string ToString(string format, IFormatProvider formatProvider)
        {
            ...
            return string.Format(format, formatProvider, "[M11:{0} M12:{1}] [M21:{2} M22:{3}] [M31:{4} M32:{5}]",
                ...
                M12.ToString(format, formatProvider), M21.ToString(format, formatProvider),
        ...
        public bool Equals(ref Matrix3x2 other)
        {
            return MathUtil.NearEqual(other.M11, M11) && MathUtil.NearEqual(other.M12, M12) &&
                   ...
                   MathUtil.NearEqual(other.M22, M22) && MathUtil.NearEqual(other.M31, M31) &&
