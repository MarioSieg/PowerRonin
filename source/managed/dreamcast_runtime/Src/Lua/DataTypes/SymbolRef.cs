...
namespace Dreamcast.Lua.Interpreter
{
    ...
    public class SymbolRef
    {
        ...
        {
            return new() {i_Index = -1, i_Type = SymbolRefType.Global, i_Env = envSymbol, i_Name = name};
        }
        ...
        internal static SymbolRef Local(string name, int index)
        {
            ...
            return new() {i_Index = index, i_Type = SymbolRefType.Local, i_Name = name};
        }
        ...
        {
            //Debug.Assert(index >= 0, "Symbol Index < 0");
            return new() {i_Index = index, i_Type = SymbolRefType.Upvalue, i_Name = name};
        }
