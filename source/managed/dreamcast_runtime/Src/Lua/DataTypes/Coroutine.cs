...
namespace Dreamcast.Lua.Interpreter
{
    ...
    public class Coroutine : RefIdObject, IScriptPrivateResource
    {
        ...
        {
            foreach (DynValue v in AsTypedEnumerable()) yield return v.ToScalar().ToObject();
        }
        ...
        {
            foreach (DynValue v in AsTypedEnumerable()) yield return v.ToScalar().ToObject<T>();
        }
...
#pragma warning disable 0219
            foreach (DynValue v in AsTypedEnumerable()) yield return null;
