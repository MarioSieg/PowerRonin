...
namespace MoonSharp.Interpreter.Tree
{
    internal class Token
    {
        ...
        {
            return new(SourceId, FromCol, ToCol, FromLine, ToLine, isStepStop);
        }

        internal SourceRef GetSourceRef(Token to, bool isStepStop = true)
        {
            return new(SourceId, FromCol, to.ToCol, FromLine, to.ToLine, isStepStop);
        }

        internal SourceRef GetSourceRefUpTo(Token to, bool isStepStop = true)
        {
            return new(SourceId, FromCol, to.PrevCol, FromLine, to.PrevLine, isStepStop);
        }
    }
}