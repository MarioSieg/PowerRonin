...
namespace Dreamcast.Json
{
    ...
    public class JsonTextReader : JsonReader, IJsonLineInfo
    {
        ...
        private void SetNewLine(bool hasNextChar)
        {
            ...
            if (hasNextChar && _chars[_charPos] == StringUtils.LineFeed) _charPos++;
        ...
        private void ShiftBufferIfNeeded()
        {
            ...
            if (length - _charPos <= length * 0.1 || length >= LargeBufferLength)
            {
                ...
                if (count > 0) BlockCopyChars(_chars, _charPos, _chars, 0, count);
        ...
        {
            if (_charPos + relativePosition >= _charsUsed) return ReadChars(relativePosition, append);
