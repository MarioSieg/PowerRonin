...
{
    internal class FSharpDreamcast.Json.Serialization.Function
    {
        private readonly object? _instance;
        private readonly MethodCall<object?, object> _invoker;

        public FSharpDreamcast.Json.Serialization.Function(object? instance, MethodCall<object?, object> invoker)
        {
            _instance = instance;
            _invoker = invoker;
        }
    ...
    internal class FSharpUtils
    {
        ...
        public Dreamcast.Json.Serialization.Func<object, object> GetUnionCaseInfoDeclaringType { get; private set; }
        public Dreamcast.Json.Serialization.Func<object, object> GetUnionCaseInfoName { get; private set; }
        public Dreamcast.Json.Serialization.Func<object, object> GetUnionCaseInfoTag { get; private set; }
        ...
        private static MethodInfo GetMethodWithNonPublicFallback(Type type, string methodName, BindingFlags bindingFlags)
        {
            ...
            // https://github.com/JamesNK/Dreamcast.Json/pull/649
            // https://github.com/JamesNK/Dreamcast.Json/issues/821
        ...
        private static MethodCall<object?, object> CreateFSharpDreamcast.Json.Serialization.FuncCall(Type type, string methodName)
        {
            ...
            return createDreamcast.Json.Serialization.Function;
        }
