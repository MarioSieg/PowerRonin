...
namespace dce::gui::widgets {
	...
	public:
		...
		static constexpr const char *const MESH_FILE_FILTER =
			",dae,blend,bvh,3ds,ase,obj,ply,dxf,ifc,nff,smd,vta,mdl,md2,md3,pk3,mdc,md5mesh,x,raw,ac,stl,dxf,irrmesh,xml,off,ter,mdl,hmp,mesh,xml,ms3d,lwo,lws,lxo,csm,cob,scn";
