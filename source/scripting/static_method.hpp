...
namespace PowerRonin::Scripting
{
	...
	public:
		...
		void query_from_class(StaticClass& _class
		                      , const std::string_view _name
		                      , const std::uint8_t _params_count_ = 0
		                      , const bool _do_not_jit_compile = false);
		...
		void call(RuntimeEnvironment& _env, void** const _args = nullptr) const;
		...
		/// <param name="_env"></param>
		/// <param name="_args"></param>
		void operator()(RuntimeEnvironment& _env, void** const _args = nullptr) const;
