...
namespace dce {
	/// <summary>
	/// Contains all render state flags.
	/// </summary>
	struct RenderFlags final {
		enum Enum : std::uint64_t {
			...
			DEPTH_TEST_LESS_EQUAL = 0x0000000000000020,
			DEPTH_TEST_EQUAL = 0x0000000000000030,
			DEPTH_TEST_GREATER_EQUAL = 0x0000000000000040,
			DEPTH_TEST_GREATER = 0x0000000000000050,
			DEPTH_TEST_NOT_EQUAL = 0x0000000000000060,
			...
			BLEND_SOURCE_COLOR = 0x0000000000003000,
			BLEND_INVERSE_SOURCE_COLOR = 0x0000000000004000,
			BLEND_SOURCE_ALPHA = 0x0000000000005000,
			BLEND_INVERSE_SOURCE_ALPHA = 0x0000000000006000,
			BLEND_DESTINATION_ALPHA = 0x0000000000007000,
			BLEND_INVERSE_DESTINATION_ALPHA = 0x0000000000008000,
			BLEND_DESTINATION_COLOR = 0x0000000000009000,
			BLEND_INVERSE_DESTINATION_COLOR = 0x000000000000a000,
			BLEND_SOURCE_ALPHA_SATURATED = 0x000000000000b000,
			BLEND_FACTOR = 0x000000000000c000,
			BLEND_INVERSE_FACTOR = 0x000000000000d000,
			...
			BLEND_EQUATION_REVERSED_SUB = 0x0000000020000000,
			...
			LINE_AA = 0x0200000000000000,
			CONSERVATIVE_RASTER = 0x0400000000000000,
			DEFAULT = WRITE_RGB | WRITE_A | WRITE_Z | DEPTH_TEST_LESS | MSAA | CULL_CCW
		};
	};
