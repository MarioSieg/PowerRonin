...
namespace PowerRonin
{
	...
	[[nodiscard]]
	extern auto MoAlloc(void* domain, void* klass, void* ctor = nullptr, void** ctorArgs = nullptr, bool isPinned = false) -> std::uint32_t;
	...
	[[nodiscard]]
	extern auto MoUnwrap(std::uint32_t gcRef) noexcept -> void*;
	...
	[[nodiscard]]
	extern auto MoUnbox(std::uint32_t gcRef) noexcept -> void*;
}
