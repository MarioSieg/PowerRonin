...
namespace PowerRonin
{
	...
	public:
		...
		[[nodiscard]] auto RenderData() const & noexcept -> const class RenderState&;

		/// <summary>
		/// 
		/// </summary>
		/// <returns>Returns the render data.</returns>
		[[nodiscard]] auto RenderData() & noexcept -> class RenderState&;
	...
	inline auto Runtime::RenderData() const & noexcept -> const class RenderState&
	{
		return this->renderData;
	}

	inline auto Runtime::RenderData() & noexcept -> class RenderState&
	{
		return this->renderData;
	}
